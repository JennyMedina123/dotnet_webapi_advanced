...
public class GuidController : ControllerBase
{
    ...
    private readonly IGuidGeneratorTransient _transientService;
    private readonly IGuidGeneratorSingleton _singletonService;
    private readonly IGuidGeneratorDeep _guidGeneratorDeep;


    public GuidController(IGuidGeneratorScope scopeService, IGuidGeneratorTransient transientService, IGuidGeneratorSingleton singletonService, IGuidGeneratorDeep guidGeneratorDeep)
    {
