...
public class GuidServiceTransient : IGuidGeneratorTransient
{
    private Guid _guid;
...
{
    private IGuidGeneratorTransient _guidGeneratorTransient;
    ...
    public GuidGeneratorDeep(IGuidGeneratorSingleton guidGeneratorSingleton,
         ...
         IGuidGeneratorTransient guidGeneratorTransient
           )
    {
    ...
    { 
        ...
        response.TransientGuid = _guidGeneratorTransient.GetGuid();
